    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-6 col-sm-6 text-center">
                <p class="texto">
                    <h4><strong>Pergunta 10:</strong></h4>
                </p>
            </div>
        </div>
        <form action="{{ route('dadosPagina10') }}" method="POST">
            @csrf
            <div class="form-group py-4">
                <label for="pergunta"><h3><strong>Qual era a bebida na qual Patrick era viciado?</strong></h3></label>
