    ...
    <div class="card-body">
        ...
        <form action="{{ route('dadosPagina4') }}" method="POST">
            ...
            <div class="form-group py-4">
                <label for="pergunta"><h3><strong>Aonde jane dorme durante praticamente a série inteira?</strong></h3></label>
                <div class="form-check py-4">
                    <input class="form-check-input" type="radio" name="pergunta" id="pergunta" value="A">
                    <label class="form-check-label" for="pergunta">
                        <h5>Em um sofá velho nas agencias da cbi e do fbi</h5>
                    </label>
                </div>
                <div class="form-check py-4">
